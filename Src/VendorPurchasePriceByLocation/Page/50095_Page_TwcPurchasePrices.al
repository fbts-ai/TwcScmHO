#if not CLEAN21
page 50095 TwcPurchasePrices
{
    Caption = 'Twc Purchase Prices';
    DataCaptionExpression = GetCaption();
    DelayedInsert = true;
    PageType = Worksheet;
    SourceTable = TWCPurchasePrice;
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field(PurchPricetype; Rec.PurchPricetype)
                {
                    Caption = 'Type';
                }
                field("Item No."; Rec."Item No.")
                {
                    ...
                    begin
                        IF Rec.PurchPricetype = Rec.PurchPricetype::Item then begin
                            TempItem.reset();
                            TempItem.setfilter("No.", '<>%1', '');
                        ...
                        IF Rec.PurchPricetype = Rec.PurchPricetype::"Fixed Asset" then begin
                            ...
                            IF PAGE.RUNMODAL(50112, TempFixedAsset) = ACTION::LookupOK THEN begin//ALLE_NICK_021424
                                Rec."Item No." := TempFixedAsset."No.";
                                Rec.Validate(Rec."Item No.");
                            end;
    ...
    var
        ...
        test: Page "Tax Information Factbox";
    begin
        if FilterTxt = '' then
            exit;
