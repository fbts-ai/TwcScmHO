page 50146 "FA Transfer Order"
{
    Caption = 'FA Direct Transfer Order';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Direct Transfer"; Rec."Direct Transfer")
                {
                    ...
                    begin
                        ...
                        transferline.validate("Item No.", '9999999');
                        transferline.Insert();
                        // transferline.Modify();
                        CurrPage.Update();
                    end;
            ...
            part(TransferLines; "FA Transfer Order Subform")//nick
            {
                ApplicationArea = Location;
                Editable = IsTransferLinesEditable;
                Enabled = IsTransferLinesEditable;
                SubPageLink = "Document No." = FIELD("No."),
                              "Derived From Line No." = CONST(0), "Item No." = filter('9999999');
