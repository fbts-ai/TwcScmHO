report 50197 "Item Age Composition -Qty."
{
    DefaultLayout = RDLC;
    RDLCLayout = './InventoryMgt/ItemAgeCompositionQty.rdl';
    ApplicationArea = Basic, Suite;
    //Caption = 'Item Age Composition - QuantityNew';
    Caption = 'Location wise item Age composition - Quantity';
