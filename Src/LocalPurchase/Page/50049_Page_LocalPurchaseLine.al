page 50049 "Local Purchase Order Subform"
{
    AutoSplitKey = true;
    Caption = 'Local Purchase Order Subform';
    DelayedInsert = true;
    LinksAllowed = false;
            ...
            repeater(Control1)
            {
                ...
                field("No."; Rec."No.")
                {
                    ...
                    begin
                        ...
                        if TempItem.Get("No.") then;
                        if not TempItem.LocalPurchase Then
                            error('Slect articles with Only inetrstore allow as true');
                    ...
                    var
                        TempItem: Record "Item";
                    begin
                        TempItem.SetFilter(TempItem.LocalPurchase, '%1', true);
                ...
                field("Item Reference No."; Rec."Item Reference No.")
                {
                    ...
                    begin
                        ...
                        DeltaUpdateTotals();
#if not CLEAN20
                        // OnCrossReferenceNoOnLookup(Rec); Mahendra 06 April 2023
#endif
                ...
                */
                ...
                //     end;
                // }
                field("Direct Unit Cost"; rec."Direct Unit Cost") //PT-FBTS-16-10-24
                {
                    ApplicationArea = Suite;
                    BlankZero = true;
                    Editable = NOT IsBlankNumber;
            ...
            group(AutoLotAssignment)
            {
                action(AutoLotAssignShipment)
                {
                    ...
                    var
                        ...
                        LocalPurchcodeunit: Codeunit AllSCMCustomization;
                            ...
                            repeat
                                ...
                                IF not ValidateReservationEntry.FindFirst() then begin
                                    ...
                                    if TempIetm."Item Tracking Code" <> '' then Begin
                                        ...
                                        LocalPurchcodeunit.LocalPurchaseReservationEntry(TempPurchLine);
                                    end;
                                End;
