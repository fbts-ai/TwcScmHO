// codeunit 50008 "EInvoiceTransfer"
// {
//     Permissions = tabledata "Transfer Shipment Header" = rm;

//     procedure CreateTransfereInvoice()
//     var
//     begin
//         Initialize();
...
//     procedure TransferEwayBillFromIRN()
//     var
//     begin
//         Initialize();
...
//     begin
//         JSellerDetails.Add('Gstin', GSTRegistrationNo);//GSTRegistrationNo); '27AAAPI3182M002'//hardcoded need to change
...
//         JDocTotalDetails.Add('Assval', Round(AssessableAmount, 0.01, '='));
//         JDocTotalDetails.Add('CgstVal', Round(CGSTAmount, 0.01, '='));
//         JDocTotalDetails.Add('SgstVAl', Round(SGSTAmount, 0.01, '='));
//         JDocTotalDetails.Add('IgstVal', Round(IGSTAmount, 0.01, '='));
//         JDocTotalDetails.Add('CesVal', Round(CessAmount, 0.01, '='));
//         JDocTotalDetails.Add('CesNonAdVal', Round(CessNonAdvanceVal, 0.01, '='));
//         JDocTotalDetails.Add('Disc', Round(DiscountAmount, 0.01, '='));
//         JDocTotalDetails.Add('OthChrg', Round(OtherCharges, 0.01, '='));
...
//         JDocTotalDetails.Add('TotInvVal', Round(TotalInvoiceAmount, 0.01, '='));
...
//         JItem.Add('TotAmt', Round(TotAmount)); //PT-FBTS
//         JItem.Add('Discount', Discount);
//         JItem.Add('OthChrg', OtherCharges);
//         JItem.Add('AssAmt', Round(AssessableAmount));//PT-FBTS
...
//         JItem.Add('TotItemVal', Round(TotalItemValue));//PT-FBTS
