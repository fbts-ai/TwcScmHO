...
codeunit 51103 "Cost Adjustment Subscribers"
{
    ...
    [EventSubscriber(ObjectType::Report, Report::"Adjust Cost - Item Entries1", OnBeforeRunCostAdjustment, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Report, Report::"Adjust Cost - Item Entries1", OnAfterRunCostAdjustment, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Report, Report::"Adjust Cost - Item Entries1", OnRegisterSuccess, '', false, false)]
    local procedure RegisterSuccessRegularRun()
    begin
        TempCostAdjustmentLog.Status := TempCostAdjustmentLog.Status::Success;
    end;

    [EventSubscriber(ObjectType::Report, Report::"Adjust Cost - Item Entries1", OnRegisterFailure, '', false, false)]
