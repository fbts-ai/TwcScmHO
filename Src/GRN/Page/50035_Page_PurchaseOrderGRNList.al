page 50035 "Purchase Order GRN List"
{
    ApplicationArea = All;

    Caption = 'Purchase Order GRN List';
    CardPageID = "PurchaseOrderGRN";
    ...
    begin
        ...
        Rec.SetRange(Rec.LocalPurchase, false);
        Rec.SetRange(Rec."Completely Received", false);
        Rec.SetRange(ShortClosed, false);//PT-FBTS
        rec.FilterGroup(0);
        //end
