// codeunit 50000 "Inventory Adjustment1" implements "Inventory Adjustment"
// {
...
//         tempItemApplnEntry: Record "Item Application Entry";
//         UseApplnEntryAsTemp: boolean;
...
//             IF TheItem.FINDSET(FALSE, FALSE) THEN //HEI.02
//                 repeat
//                     Item := TheItem;
//                     GetItem("No.");
...
//                 if OutbndItemApplnEntry.FINDSET(FALSE, FALSE) then
//                     repeat
...
//             OutbndValueEntry.FINDSET(FALSE, FALSE);
//             repeat
...
//         IF ItemApplicationEntry.FINDSET(FALSE, FALSE) THEN
...
//     begin
//         with ValueEntry do begin
//             SETCURRENTKEY("Item Ledger Entry No.", "Entry Type", "Item Charge No.", "Document Line No.");
...
//             IF TransValueEntry.FINDSET(FALSE, FALSE) THEN
//                 repeat
//                     if TempInvtAdjmtBuf.Get(TransValueEntry."Entry No.") then
//                         TransValueEntry.AddCost(TempInvtAdjmtBuf);
//                     "Actual Cost" := "Actual Cost" + TransValueEntry."Cost Amount (Actual)";
...
//         //HEI.02<<
//         IF UseApplnEntryAsTemp THEN BEGIN
//             WITH tempItemApplnEntry DO BEGIN
//                 RESET;
//                 SETCURRENTKEY(
...
//                 //IF FINDSET THEN //HEI.02
//                 IF FINDSET(FALSE, FALSE) THEN //HEI.02
//                     REPEAT
...
//     //Ashish-NS
//     procedure InitTempApplicationEntry()
//     var
//         myInt: Integer;
//         recAccPeriodFrom: Record "Accounting Period";
//         recAccPeriodTo: Record "Accounting Period";
//     begin

//         //HEI.03<<
//         recAccPeriodFrom.SETASCENDING("Starting Date", TRUE);

//         recAccPeriodFrom.SETRANGE(Closed, FALSE);
//         recAccPeriodFrom.SETRANGE("Date Locked", FALSE);
//         recAccPeriodFrom.FINDFIRST;

//         recAccPeriodTo.SETASCENDING("Starting Date", FALSE);
//         recAccPeriodTo.SETRANGE(Closed, FALSE);
//         recAccPeriodTo.SETRANGE("Date Locked", FALSE);
//         recAccPeriodTo.FINDFIRST;

//         CLEAR(tempItemApplnEntry);

//         ItemApplnEntry.RESET();
//         ItemApplnEntry.SETRANGE("Posting Date", recAccPeriodFrom."Starting Date", recAccPeriodTo."Starting Date");
//         IF ItemApplnEntry.FINDSET() THEN
//             REPEAT
//                 tempItemApplnEntry.INIT();
//                 tempItemApplnEntry.TRANSFERFIELDS(ItemApplnEntry);
//                 tempItemApplnEntry.INSERT(FALSE);
//             UNTIL ItemApplnEntry.NEXT = 0;
//         UseApplnEntryAsTemp := TRUE;
//         //HEI.03>>
//     End;

//     procedure ClearTempApplicationEntry()
//     var
//         myInt: Integer;
//     begin
//         CLEAR(tempItemApplnEntry);
//         UseApplnEntryAsTemp := FALSE;
//     End;
...
//     begin
//         CLEAR(tempItemApplnEntry);
//         tempItemApplnEntry.COPY(iTempApplicationEntry, TRUE);
//         UseApplnEntryAsTemp := TRUE;
//     end;
